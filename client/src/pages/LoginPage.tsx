  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (typeof err === 'object' && err !== null && 'response' in err) {
        ...
        setError(errorResponse.response.data?.error?.message || 'Invalid email or password');
      } else {
        ...
        <form className="mt-8 space-y-6" onSubmit={handleLogin}>
          ...
          <div>
            <a
              ...
              className="w-full flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none"
            >
